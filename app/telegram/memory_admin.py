...
def menu()->types.InlineKeyboardMarkup:
    ...
    kb.add(types.InlineKeyboardButton('🎯 Choose Chat',callback_data='owner:chats'),types.InlineKeyboardButton('🧪 Merva Lab',callback_data='mad:open'),types.InlineKeyboardButton('🤖 Automation',callback_data='auto:home'),types.InlineKeyboardButton('🔑 AI Providers',callback_data='owner:providers'),types.InlineKeyboardButton('🧠 Memory',callback_data='memadmin:memory'),types.InlineKeyboardButton('💬 Messages',callback_data='memadmin:messages'),types.InlineKeyboardButton('🗑️ Delete Message',callback_data='delmsg:open'),types.InlineKeyboardButton('🖼️ Media',callback_data='memadmin:media'),types.InlineKeyboardButton('👤 Users',callback_data='memadmin:users'),types.InlineKeyboardButton('⚙️ Bot Settings',callback_data='memadmin:settings'),types.InlineKeyboardButton('🗄️ Database',callback_data='memadmin:db'),types.InlineKeyboardButton('📊 Status',callback_data='memadmin:status'))
    return kb
...
def provider_menu(providers):
    kb=types.InlineKeyboardMarkup(row_width=2); labels={'groq':'🟢 Groq','gemini':'🔵 Gemini','openai':'⚫ OpenAI','deepseek':'🔴 DeepSeek','openrouter':'🟣 OpenRouter','together':'🟠 Together'}
...
def provider_actions(provider):
    kb=types.InlineKeyboardMarkup(row_width=2)
    kb.add(types.InlineKeyboardButton('➕ Add key',callback_data=f'owner:padd:{provider}'),types.InlineKeyboardButton('📋 Keys',callback_data=f'owner:plist:{provider}'))
    kb.add(types.InlineKeyboardButton('🗑️ Delete key',callback_data=f'owner:pdelete:{provider}'),types.InlineKeyboardButton('🔄 Test',callback_data=f'owner:ptest:{provider}'))
    kb.add(types.InlineKeyboardButton('⬅️ Providers',callback_data='owner:providers')); return kb
