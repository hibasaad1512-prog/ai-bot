...
def menu()->types.InlineKeyboardMarkup:
    ...
    kb.add(types.InlineKeyboardButton('🎯 Choose Chat',callback_data='owner:chats'),types.InlineKeyboardButton('🧪 Merva Lab',callback_data='mad:open'),types.InlineKeyboardButton('⚡ Activity & Media',callback_data='auto:home'),types.InlineKeyboardButton('🔑 AI Providers',callback_data='owner:providers'),types.InlineKeyboardButton('🧠 Memory',callback_data='memadmin:memory'),types.InlineKeyboardButton('💬 Messages',callback_data='memadmin:messages'),types.InlineKeyboardButton('🗑️ Delete Message',callback_data='delmsg:open'),types.InlineKeyboardButton('🖼️ Media',callback_data='memadmin:media'),types.InlineKeyboardButton('👤 Users',callback_data='memadmin:users'),types.InlineKeyboardButton('🗄️ Database',callback_data='memadmin:db'),types.InlineKeyboardButton('📊 Status',callback_data='memadmin:status'))
    return kb
