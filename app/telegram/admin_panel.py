...
LANGUAGES=[
("🌐 Auto","auto"),("🇲🇦 Moroccan Darija","ar-MA"),("🇸🇦 Arabic","ar"),("🇬🇧 English","en"),("🇫🇷 French","fr"),("🇪🇸 Spanish","es"),("🇵🇹 Portuguese","pt"),("🇷🇺 Russian","ru"),("🇺🇦 Ukrainian","uk"),("🇹🇷 Turkish","tr"),("🇩🇪 German","de"),("🇮🇹 Italian","it"),("🇳🇱 Dutch","nl"),("🇵🇱 Polish","pl"),("🇷🇴 Romanian","ro"),("🇨🇿 Czech","cs"),("🇸🇰 Slovak","sk"),("🇭🇺 Hungarian","hu"),("🇸🇪 Swedish","sv"),("🇳🇴 Norwegian","no"),("🇩🇰 Danish","da"),("🇫🇮 Finnish","fi"),("🇬🇷 Greek","el"),("🇮🇱 Hebrew","he"),("🇮🇳 Hindi","hi"),("🇵🇰 Urdu","ur"),("🇮🇩 Indonesian","id"),("🇲🇾 Malay","ms"),("🇵🇭 Tagalog","tl"),("🇯🇵 Japanese","ja"),("🇰🇷 Korean","ko"),("🇨🇳 Chinese","zh")]

def panel(p, language="auto"):
    kb=types.InlineKeyboardMarkup(row_width=2)
    for label,key in FIELDS: kb.add(types.InlineKeyboardButton(f"{label}: {getattr(p,key)}",callback_data=f"set:{key}:show"))
