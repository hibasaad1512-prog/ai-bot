...
class OpenAICompatibleProvider(AIProvider):
    ...
    def _request(self,messages,**extra):
        ...
        r=requests.post(f'{self.base_url}/chat/completions',headers={'Authorization':f'Bearer {self.api_key}','Content-Type':'application/json'},json={'model':self.model,'messages':messages,**extra},timeout=60); r.raise_for_status(); return r.json()
